...
- Standard and premium now contain visible neutral “Über mich” sections. The unapproved Ukraine/Baufirma/Donbass biography remains excluded pending Denys' exact written approval.
...
- Verified locally on the current branch: Astro check/build, static/link/asset/JSON gates, 31 passing Playwright checks across desktop/mobile (one expected desktop skip), Ukrainian chooser/back navigation, both about sections, composite/copy/download controls, axe with no serious/critical findings, screenshots, and Lighthouse budgets. Scores: overview 1.00/1.00/1.00 and Kleinanzeigen 0.99/1.00/1.00 for performance/accessibility/best-practices; preview SEO remains intentionally reduced by noindex.
